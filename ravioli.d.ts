...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h54c5ef0285851dc0: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h698a58ec60ac8c0c: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h709f70db6b0af24b: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5770e4f6df08492d: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_4: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h276cfbcbdbf4afb5_10: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hd0a4e5ecc651b732: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h17292cd520d31c19: (a: number, b: number) => void;
