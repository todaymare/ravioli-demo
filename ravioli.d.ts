...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h3370ebd7e2be8d50: (a: number, b: number, c: any, d: any) => void;
  readonly wasm_bindgen__closure__destroy__h0bdf1ceddb52e82c: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h198a5dec384fef6c: (a: number, b: number, c: any) => void;
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h20447c9d8194d48f: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hddb19273cdb2c567: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h924a0a65995129af: (a: number, b: number) => void;
